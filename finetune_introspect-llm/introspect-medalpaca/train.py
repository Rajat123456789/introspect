...
def main(
    ...
    prompt_template: str = "prompt_templates/introspect-medalpaca.json",
    ...
    **kwargs
    ...
    prompt_template (str, optional):
        The path to the JSON file containing prompt templates. Default is "prompt_templates/introspect-medalpaca.json".
